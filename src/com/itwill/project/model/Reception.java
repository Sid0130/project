...
public class Reception {
	...
	public static final class Entity {
		...
		public static final String COL_RECEPTION_ANIMAL_ID = "ANIMAL_ID";
		public static final String COL_RECEPTION_DOCTOR_ID = "DOCTOR_ID";
		public static final String COL_RECEPTION_OWNER_ID = "OWNER_ID";
	...
	public Reception(int id, int animalId, int doctorId, int ownerId, Timestamp appointmentTime, String receptionStatus,
	...
	public String toString() {
		return "Reception [id=" + id + ", animalId=" + animalId + ", doctorId=" + doctorId + ", ownerId=" + ownerId
				+ ", appointmentTime=" + appointmentTime + ", receptionStatus=" + receptionStatus + ", createdTime="
	...
	public static class ReceptionBuilder {
		...
		public ReceptionBuilder(Integer id, Integer animalId, Integer doctorId, Integer ownerId,
				Timestamp appointmentTime, String receptionStatus, Timestamp createdTime, Timestamp modifiedTime) {
			this.id = id;
			this.animalId = animalId;
			this.doctorId = doctorId;
			this.ownerId = ownerId;
		...
		public Reception build() {
			return new Reception(id, animalId, doctorId, ownerId, appointmentTime, receptionStatus, createdTime,
					modifiedTime);
		}
