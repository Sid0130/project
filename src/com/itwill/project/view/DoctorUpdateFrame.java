...
public class DoctorUpdateFrame extends JFrame {
	 ...
	 */
	public static void showDocotrUpdate(Component parentComponent) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DoctorUpdateFrame frame = new DoctorUpdateFrame(parentComponent);
	...
	public DoctorUpdateFrame(Component parentComponent) {
	...
	public void initialize() {
		...
		lblDoctorUpdate.setFont(new Font("D2Coding", Font.PLAIN, 25));
		...
		buttonPanel.setBounds(12, 268, 344, 30);
		contentPane.add(buttonPanel);
		
		btnUpdate = new JButton("수정");
		btnUpdate.setFont(new Font("D2Coding", Font.PLAIN, 12));
